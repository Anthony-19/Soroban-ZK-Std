---
title: "Constant-Time Implementation Notes"
description: "Techniques used in Soroban-ZK-Std to prevent timing side-channels during proof verification"
protocol: "25"
cap: "CAP-0075"
---
...
```rust
// crates/soroban-zk-core/src/lib.rs
