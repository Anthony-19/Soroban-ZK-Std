...
use soroban_zk_core::{G1Affine, Bn254};
...
| **Compilation error: `use of undeclared crate or module`** | Missing dependency | Double-check your `Cargo.toml` includes `zk-soroban` and `soroban-zk-core`. |
