...
impl FloatCore for f32 {
    ...
    #[cfg(feature = "std")]
    forward! {
        <Self as FloatCore>::floor(self) -> Self;
        <Self as FloatCore>::ceil(self) -> Self;
        <Self as FloatCore>::round(self) -> Self;
        <Self as FloatCore>::trunc(self) -> Self;
        <Self as FloatCore>::fract(self) -> Self;
        Self::abs(self) -> Self;
        Self::signum(self) -> Self;
        <Self as FloatCore>::powi(self, n: i32) -> Self;
    }
